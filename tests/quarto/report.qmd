...
#splice-map .wrap,
#splice-map svg {
  overscroll-behavior: contain; /* keep wheel/pinch from bubbling to page */
}

#splice-map .wrap {
  overflow: hidden; /* hide any horizontal scrollbar flash in the container */
}
</style>
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const cfg = {
    ...
    directionsUp:["D1","A2"],
    // links:[
    //   {from:"D1",to:"A1",w:7,label:"D1_A2_D3_A4 7%"},
    //   {from:"D1",to:"A1",w:5,label:"D1_A1 5%"},
    //   {from:"D1",to:"A1",w:4,label:"D1_A1 4%"},
    //   {from:"D1",to:"A7",w:3,label:"D1_A7 3%"},
    //   {from:"D1",to:"A2",w:3,label:"D1_A2 3%"},
    //   {from:"D1",to:"A3",w:3,label:"D1_A3 3%"},
    //   {from:"D1",to:"A4",w:3,label:"D1_A4 3%"},
    //   {from:"D2",to:"A4",w:3,label:"D2_A4 3%"},
    //   {from:"D2",to:"A5",w:3,label:"D2_A5 3%"},
    //   {from:"D2",to:"A6",w:3,label:"D2_A6 3%"},
    //   {from:"D2",to:"A7",w:3,label:"D2_A7 3%"}
    // ]
  };
  ...
  // if empty, display message inside SVG and stop drawing
  if (!links.length) {
  ...
  // if the widths are too subtle, change to .range([1,20])
  ...
  const x = d3.scaleLinear().domain([0,9000]).range([0,innerW]);
  ...
  const linkPaths = linkG.selectAll("path")
    ...
    .append("title")
      .text(d=>`${d.label || `${d.from}→${d.to}`}  (w=${d.w})`);
